...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        //        var customer = await db.FeedbackDatabase
        ...
        //        var newPassword = string.Format("{0}", random.Next(100000, 999999, abcdefghijklmnopqrstuvwxyz , ABCDEFGHIJKLMNOPQRSTUVWXYZ));
        ...
        //            await EmailClassic.(email, subject, body);
        //            return Ok(true);
        //        }
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            #region Added Code for Send Email
...

                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Please confirm your Service Rating  account by clicking <a href=\"" + callbackUrl + "\">here</a>");
       ...
       [HttpGet]
...

        {
            ...
            return Ok(result.Succeeded ? "Now you Can able to Successfully login" : "Error");
